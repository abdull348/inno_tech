...
const Hero = () => {
  return (
    <>
      <Helmet>
        <title>InnoTech Technologies - Innovative Lab Solutions</title>
        <meta
          name='description'
          content='Welcome to InnoTech Technologies. We provide cutting-edge laboratory equipment solutions for life sciences and research'
        />
        <meta
          name='keywords'
          content='InnoTech, InnoTech Technologies, Laboratory Equipment, Science Technology, Research Solutions'
        />
        <link rel='canonical' href='https://innotechtechnologies.us/' />
      </Helmet>
      <div
