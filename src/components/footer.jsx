      ...
      <div className='container'>
            ...
            <div className='d-flex mb-3'>
              ...
              <div>
                <a
                  ...
                  className='small text-white-50 d-block text-decoration-none hover-primary fw-normal'
                >
            ...
            <div className='d-flex'>
              ...
              <div>
                <a
                  ...
                  className='small text-white-50 text-decoration-none hover-primary fw-normal'
                >
                  +1 (818) 943-1786
                </a>
                <p className='small text-white-50 mb-0 mt-1 fw-normal'>
                  Mon-Fri: 8AM - 6PM EST
                </p>
              </div>
            </div>
              ...
              <ul className='list-unstyled'>
                {section.links.map((link, linkIndex) => (
                  <li key={linkIndex} className='mb-2'>
                    <Link
                      to={link.url}
                      className='text-white-50 small text-decoration-none hover-primary fw-normal'
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        <div className='row align-items-center text-center text-md-start'>
          <div className='col-md-6'>
            <p className='small text-white-50 mb-0 fw-normal'>
          ...
          <div className='col-md-6 text-md-end mt-3 mt-md-0'>
            <p className='small text-white-50 mb-0 fw-normal'>
              ...
              <a
                ...
                className='text-white-50 text-decoration-none fw-normal'
              >
                Devprimo
              </a>
            </p>
